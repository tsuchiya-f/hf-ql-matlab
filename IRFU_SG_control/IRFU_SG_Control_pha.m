...
n_set = 9;
for i=1:n_set
    s(i)=struct('freq', freq_set,'amp_x', amp_set,'amp_y', amp_set,'amp_z', amp_set,'pha_x',  pha_set(i),'pha_y',  0.0,       'pha_z',  0.0);
end
for i=1:n_set
    s(i+n_set)=struct('freq', freq_set,'amp_x', amp_set,'amp_y', amp_set,'amp_z', amp_set,'pha_x',  0.0,       'pha_y',  pha_set(i),'pha_z',  0.0);
end
for i=1:n_set
    s(i+n_set*2)  =struct('freq', freq_set,'amp_x', amp_set,'amp_y', amp_set,'amp_z', amp_set,'pha_x',  0.0,       'pha_y',  0.0,       'pha_z', pha_set(i));
end
n_set = n_set*3;
%n_set = 9;
%for i=1:n_set
%    s(i)=struct('freq', freq_set,'amp_x', amp_set,'amp_y', amp_set,'amp_z', amp_set,'pha_x',  0.0,'pha_y',  pha_set(i),       'pha_z',  0.0);
%end
